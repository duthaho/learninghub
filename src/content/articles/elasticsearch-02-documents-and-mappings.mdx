...
*Elasticsearch deep-dive · Part 2 of 8. Previous: [Elasticsearch, from the ground up](/elasticsearch-01-mental-model/) · Next: [How Elasticsearch reads text](/elasticsearch-03-text-analysis/).*
...
<Callout type="insight" title="text vs keyword is just two analyzers on one string">
  ...
  analysis actually works in [Part 3](/elasticsearch-03-text-analysis/);
