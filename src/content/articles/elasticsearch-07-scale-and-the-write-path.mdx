...
*Elasticsearch deep-dive · Part 7 of 8. Previous: [Aggregations: the analytics engine](/elasticsearch-06-aggregations/) · Next: [When to reach for Elasticsearch](/elasticsearch-08-design-decisions/).*
...
You now have the operational half of Elasticsearch: how an index survives scale and machine death, and exactly what happens to a document between "indexed" and "searchable and durable." The final part, [Part 8: design decisions](/elasticsearch-08-design-decisions/), steps back from mechanics to judgement — *when* Elasticsearch is the right tool at all, and when reaching for it is a mistake.
